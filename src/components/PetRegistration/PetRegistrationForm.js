...
class PetRegistrationForm extends React.Component {
  ...
  listButtonClick(type) {
    ...
    if (type == 'RaceDD') {
      this.setState(state => ((state.data = {felinoRaceListdata}), state))
    }
    ...
    return <ScrollView contentContainerStyle={styles.contentContainer}>
        <TouchableWithoutFeedback onPress={() => this.setState({
          ...
          <Modal  backdropOpacity={0.5} isVisible={this.state.modalVisible}>
            ...
            if (x == 1)
            {<View style={{ height: 250, width: "100%", backgroundColor: "pink" }}>
            <FlatList contentContainerStyle={styles.flatListContentContainerStyle} data={this.state.dropDownData} renderItem={({ item, index }) => {
        ...
        <View style={styles.clinicHistoryContainer}>
          ...
          <TouchableOpacity id="1" style={styles.originTextInputStyle} onPress={()=>this.listButtonClick('RaceDD')}>
          ...
          <View style={styles.TextInputContainer}>
            ...
            <TouchableOpacity id="2" style={styles.originTextInputStyle} onPress={() => console.log("SexButtonClicked")}>
              <Text style={styles.dropDownButtonTextStyle}>
                {I18n.get("SelectSex")}
              </Text>
              <Image style={styles.dropDownIconStyle} source={dropDownImage} />
