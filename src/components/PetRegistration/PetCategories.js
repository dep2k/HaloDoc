    ...
    render() {
        return <View style={styles.mainContainer}>
            ...
            <View style={styles.middleContainer}>
              ...
              <TouchableOpacity style={{ backgroundColor: "#BED885", borderRadius: 20, marginTop: "18%", width: "80%", height: 40, justifyContent: "center", alignItems: "center" }}>
                <Text style={{ fontSize: 17, color: "white" }}>
                  FELINO
                </Text>
              </TouchableOpacity>
              <TouchableOpacity style={{ backgroundColor: "#BED885", borderRadius: 20, marginTop: "7%", width: "80%", height: 40, justifyContent: "center", alignItems: "center" }}>
                <Text style={{ fontSize: 17, color: "white" }}>
                  CANINO
                </Text>
              </TouchableOpacity>
